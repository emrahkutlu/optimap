...
// Aussehen der GeoJson Daten definieren
        ...
        //Verkehr
	        ...
	        if (feature.properties.tags.public_transport === 'platform'){
	            return {fillColor: '#FBEF69', color: '#333333', weight: 1, fillOpacity: 0.5};
	        }
        ...
        //Ausstattung
            ...
            if (feature.properties.tags.highway === 'elevator' && feature.properties.tags.building === 'yes' ){
	            return {fillColor: '#99cc00', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
        	}
        	...
        	if (feature.properties.tags.amentiy === 'police'){
	            return {fillColor: '#2962ff', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
            }
        	if (feature.properties.tags.information === 'office'){
	            return {fillColor: '#ffffb5', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
            }
			...
			if (feature.properties.tags.shop === 'food'){
	            return {fillColor: '#FBDDFB', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
            }	//Bäckerei
        	if (feature.properties.tags.shop === 'bakery'){
	            return {fillColor: '#FBDDFB', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
	        }	//Geschäft
            if (feature.properties.tags.shop === 'yes'){
	           	return {fillColor: '#FFC1BE', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
	        }	//Telefon
	        ...
	        if (feature.properties.tags.amenity){
	        	return {fillColor: '#ffcc99', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
        	}	//Einrichtung
        	if (feature.properties.tags.amenity === 'yes'){
        		return {fillColor: '#FFF0FF', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
	        } 	//Tunnel
	        if (feature.properties.tags.tunnel === 'yes'){
	            return {fillColor: '#f0f8ff', color: '#FFFFFF', weight: 2, fillOpacity: 0.5};
	        }	//Sicherheitsdienst
			if (feature.properties.tags.description === 'security service') {
	            return {fillColor: '#f6f6f6', color: '#FFFFFF', weight: 1, fillOpacity: 0.5};
	        }	//Fläche allgemein
        	...
        	if (feature.properties.tags.building === 'train_station'){
	            return {fillColor: '#c5cbd9', color: '#333333', weight: 1, fillOpacity: 0.5};
	        }
	        if (feature.properties.tags.building === 'yes'){
	            return {fillColor: '#ffbaba', color: '#333333', weight: 1, fillOpacity: 0.5};
	        }
	        ...
	        if (feature.properties.tags.landuse === 'railway'){
	            return {fillColor: '#fff1ba', color: 'none', weight: 1, fillOpacity: 0.5};
	        }
	        if (feature.properties.tags.amenity === 'townhall'){
	            return {fillColor: '#e9b8ff', color: '333333', weight: 1, fillOpacity: 0.5};
	        }//DAch

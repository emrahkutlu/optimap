...
/*			{
        ...
        //Ausstattung
	       ...
	       if (feature.properties.tags.highway === 'elevator'){
	        ...
	        if (feature.properties.tags.building === 'yes' && !feature.properties.tags.highway ){
...
function elevatorTest(feature){
	...
	//console.log(polygonCenterLatLng)
	//$.extend(feature.geometry.coordinates[0], polygonCenterLatLng)
	delete feature.geometry.coordinates[0]
	feature.geometry.coordinates = polyCenter;
...
function getEscalatorStatus(feature){
...
$.ajax({
  ...
  url: "http://localhost/mvg/fahrgastinfo/do?_flowId=showStation&id=SB",
  type: "GET",
  crossDomain: true,
  dataType: "xml",
  //data: data,

	...
	indoorLayer = new L.Indoor(geoJSON, {
		...
		//console.log(feature.properties.tags.name);
			if (feature.properties.tags.name) {
				...
				var name = '<b>' + feature.properties.tags.name + '</b><br>';
				...
				if (description) {
					description = '<br \/>' + description + '</b>';
					popupContent += description;
				};
				if (opening) {
					opening = '<br \/>' + "Open: "+  opening + '</b>';
					popupContent += opening;
				};
				if (phone) {
					phone =  '<br \/>' + "Call: " + phone+ '</b>';
					popupContent += phone;
				};
				if (website) {
					website =  '<br \/>' + "Visit: "+ website.link(String(website)) + '</b>';

...
//	6.) Daten mit JQuery abgreifen und in geojson transformieren, stylen
	...
	function onClick(selPoi){
		...
		latLeftTopID = lefttop.lat;
		lonLeftTopID = lefttop.lng;
		latRightBtmID = rightbottom.lat;
		lonRightBtmID = rightbottom.lng;

...
// Aussehen der GeoJson Daten definieren
        ...
        //Ausstattung
	        ...
	        if (feature.properties.tags.conveying === 'forward'){
	            return {weight: 5, dashArray: '1, 10', color: '#DBE81E', "opacity": 1,"lineJoin": "miter" , "stroke-linejoin":"miter", "stroke-linecap":"square", "stroke-width":"100", lineCap: 'square'};
    		}
    		if (feature.properties.tags.conveying === 'backward'){
	            return {weight: 5, dashArray: '1, 10', color: '#5CAD0A', "opacity": 1,"lineJoin": "miter" , "stroke-linejoin":"miter", "stroke-linecap":"square", "stroke-width":"100", lineCap: 'square'};
    		}
    		if (feature.properties.tags.conveying === 'reversible'){
	            return {weight: 5, dashArray: '1, 10', color: '#6BC40C', "opacity": 1,"lineJoin": "miter" , "stroke-linejoin":"miter", "stroke-linecap":"square", "stroke-width":"100", lineCap: 'square'};
    		}
    		...
    		if (feature.properties.tags.highway === 'steps'){
	            return {weight: 5, dashArray: '1, 10', color: '#99CC00', "opacity": 1,"lineJoin": "miter" , "stroke-linejoin":"miter", "stroke-linecap":"square", "stroke-width":"100", lineCap: 'square'};
    		}	//Fußwege
        	...
        	if (feature.properties.tags.amenity === 'police'){
	            return {fillColor: '#FFCF46', color: '#FFFFFF', weight: 1, fillOpacity: 1};
            }
            if (feature.properties.tags.amenity === 'parking'){
	            return {fillColor: '#FFFBC0', color: '#FFFFFF', weight: 1, fillOpacity: 0.8};
            }
        	if (feature.properties.tags.information === 'office'){
	            return {fillColor: '#FFDE7B', color: '#FFFFFF', weight: 1, fillOpacity: 1};
            }
			...
			if (feature.properties.tags.shop === 'food'){
	            return {fillColor: '#FFBE36', color: '#FFFFFF', weight: 1, fillOpacity: 1};
            }	//Bäckerei
	        ...
	        if (feature.properties.tags.tunnel === 'yes'){
	            return {fillColor: '#f0f8ff', color: '#FFFFFF', weight: 2, fillOpacity: 1, clickable: false};
	        }	//Sicherheitsdienst
        	...
        	if (feature.properties.tags.building === 'train_station'){
	            return {fillColor: '#c5cbd9', color: '#333333', weight: 1, fillOpacity: 1, clickable: false};
	        }
	        if (feature.properties.tags.building === 'yes'){
	            return {fillColor: '#FF9C30', color: '#333333', weight: 1, fillOpacity: 1};
	        }
...
//	Daten mit JQuery abgreifen und in geojson transformieren, stylen
	$.get("http://overpass-api.de/api/interpreter?data=" + query, function(data){
		...
		highWays = new L.Indoor(geoJSON, {
			...
			style: function(feature) {
				if (feature.properties.tags.highway === 'footway'){
					return {color: '#e4f3e4', weight: 4, opacity: 0.8};
				}
				if (feature.properties.tags.highway === 'steps'){
					return {color: '#e4f3e4', weight: 3, opacity: 0.8, dashArray: 3.3};
				}
			},
	//PointtoLayer macht das keine dominanten Marker für Punktobjekte ausgegeben werden!
			pointToLayer: function (feature, latlng){
...
//## Beginn UNTERE Highways-Ebene
	...
	highWaysD = new L.Indoor(geoJSONc, {
		...
		style: function(feature) {
			if (feature.properties.tags.highway === 'footway'){
				return {color: '#7fc084', weight: 4, opacity: 0.3};
			}
			if (feature.properties.tags.highway === 'steps'){
				return {color: '#7fc084', weight: 3, opacity: 0.4, dashArray: 3.3};
			}
		},
//PointtoLayer macht das keine dominanten Marker für Punktobjekte ausgegeben werden!
		pointToLayer: function (feature, latlng){

...
function getCoords(){
	...
	// Addiere Werte, damit nicht immer Daten  für GeoJSONPoi nachgeladen werden bei Kartenverschieben --> vergrößerte BBOX
...
// Aussehen der GeoJson Daten definieren
        ...
        //Ausstattung	
	        ...
	        if(feature.properties.tags.area === 'yes') {
	        	return {fillColor: '#CED7E0', color: '#FFFFFF', weight: 2, fillOpacity: 0.1};
	        }
		}
   });
